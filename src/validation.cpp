...
#if defined(NDEBUG)
# error "Pawscoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Pawscoin Signed Message:\n";
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    // Subsidy is cut in half every X blocks which will occur approximately every Y years.
    nSubsidy >>= halvings;
    return nSubsidy;
}
