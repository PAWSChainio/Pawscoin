...
Below are some notes on how to build Pawscoin Core for Windows.

The options known to work for building Pawscoin Core on Windows are:

* On Linux using the [Mingw-w64](https://mingw-w64.org/doku.php) cross compiler tool chain. Ubuntu Trusty 14.04 is recommended
and is the platform used to build the Pawscoin Core Windows release binaries.
...
for Ubuntu Xenial does not produce working executables for some of the Pawscoin Core applications.
...
Note that for WSL the Pawscoin Core source path MUST be somewhere in the default mount file system, for
...
The next three steps are an example of how to acquire the source in an appropriate way.
    ...
    cd /usr/src
    sudo git clone https://github.com/PAWSChainio/Pawscoin.git
