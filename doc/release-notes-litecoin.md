Pawscoin Core version *0.15.1* is now available from:

  <https://download.pawschain.io/litecoin-0.15.1/>
...
A number of changes to the way Pawscoin Core deals with peer connections and invalid blocks
