...
* Update manpages, see [gen-manpages.sh](https://github.com/PAWSChainio/Pawscoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/PAWSChainio/Pawscoin.git

### Pawscoin maintainers/release engineers, suggestion for writing release notes
...
### Build and sign Pawscoin Core for Linux, Windows, and OS X:
...
- Detached signatures will then be committed to the [litecoin-detached-sigs](https://github.com/PAWSChainio/Pawscoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the pawschain.io server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the pawschain.io server.

```

- Update pawschain.io version

- Announce the release:

  - litecoin-dev and litecoin-dev mailing list

  - blog.pawschain.io blog post

  - Update title of #litecoin and #litecoin-dev on Freenode IRC

  - Optionally twitter, reddit /r/Pawscoin, ... but this will usually sort out itself

  - Archive release notes for the new version to `doc/release-notes/` (branch `master` and branch of the release)

  - Create a [new GitHub release](https://github.com/PAWSChainio/Pawscoin/releases/new) with a link to the archived release notes.
